class script(object):
    START_TXT = """Hᴇʟʟᴏ {}❣,
ᴍʏ ɴᴀᴍᴇ ɪꜱ <a href=https://t.me/{}>{}</a>, ɪ ᴄᴀɴ ᴘʀᴏᴠɪᴅᴇ ʏᴏᴜ ᴍᴏᴠɪᴇꜱ ᴊᴜꜱᴛ ᴀᴅᴅ ᴍᴇ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ ᴀɴᴅ ꜱᴇᴇ ᴍʏ ᴘᴏᴡᴇʀ  ❤️‍🔥 """
    HELP_TXT = """𝙷𝙴𝚈 {}
𝘏𝘦𝘳𝘦 𝘐𝘴 𝘛𝘩𝘦 𝘏𝘦𝘭𝘱 𝘍𝘰𝘳 𝘔𝘺 𝘊𝘰𝘮𝘮𝘢𝘯𝘥𝘴."""
    ABOUT_TXT = """
𝗧𝗛𝗜𝗦 𝗜𝗦 𝑺𝒂𝒎𝒂𝒏𝒕𝒉𝒂 𝑨𝒌𝒌𝒊𝒏𝒆𝒏𝒊  𝗔𝗕𝗢𝗨𝗧 𝗠𝗦𝗚
✵✵✵✵✵✵✵✵✵✵✵✵✵✵✵✵✵✵✵✵
╔════❰ ꪖ᥇ꪮꪊ𝓽 ꪑ𝘴ᧁ ❱═❍⊱❁۪۪
║╭━━━━━━━━━━━━━━━➣ 
║┣⪼ 𝙼𝚈 𝙽𝙰𝙼𝙴- <a href="https://t.me/MnowEvo_Jennie_bot"> 𝑺𝒂𝒎𝒂𝒏𝒕𝒉𝒂 𝑨𝒌𝒌𝒊𝒏𝒆𝒏𝒊 </a>
║┣⪼ 𝙼𝚈 𝙳𝙴𝚅 - <a href="https://t.me/GHCHEKAVAN"> 𝔾ℍ_𝙲𝙷𝙴𝙺𝙰𝚅𝙰𝙽_777 </a>
║┣⪼ 𝙻𝙸𝙱𝚁𝙰𝚁𝚈 - 𝙿𝚈𝚁𝙾𝙶𝚁𝙰𝙼
║┣⪼ 𝙻𝙰𝙽𝙶𝚄𝙰𝙶𝙴 - 𝙿𝚈𝚃𝙷𝙾𝙽 𝟹
║┣⪼ 𝙳𝙰𝚃𝙰 𝙱𝙰𝚂𝙴- 𝙼𝙾𝙽𝙶𝙾 𝙳𝙱
║┣⪼ 𝙱𝙾𝚃 𝚂𝙴𝚁𝚅𝙴𝚁-  𝙷𝙴𝚁𝙾𝙺𝚄
...
- ՏOᑌᖇᑕᗴ ᑕOᗪᗴ - <a href="https://t.me/SMP_SIRI_BOT"> 𝗖𝗟𝗜𝗖𝗞 𝗛𝗘𝗥𝗘 </a>

𝗠𝗔𝗦𝗧𝗘𝗥:
<a href="https://t.me/MALAYALI_DUDE"> 𝕊𝕞𝕡 🇮🇳  </a>"""
